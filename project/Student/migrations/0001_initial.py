# Generated by Django 3.0 on 2021-05-23 12:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_tablets', models.IntegerField(blank=True)),
                ('donated_tablets', models.IntegerField(blank=True, null=True)),
                ('remaining_tablets', models.IntegerField()),
                ('days_count', models.DateField(blank=True)),
                ('created_date', models.DateField(auto_now=True)),
                ('required_tablets', models.IntegerField(blank=True)),
                ('donated_date', models.DateField(blank=True)),
