...
class DonorForm(forms.ModelForm):
	class Meta:
		model=MedicineInfo
		fields=['pharmacy_name','medicine_name','quantity','category','production_date','expiry_date','org_name','tablets_required']
		widgets={
		"pharmacy_name":forms.TextInput(attrs={"class":"form-control","placeholder":"Enter pharmacy name","readOnly":True}),
		"medicine_name":forms.TextInput(attrs={"class":"form-control","placeholder":"Medicine name","readOnly":True}),
		"quantity":forms.TextInput(attrs={"class":"form-control","placeholder":"Enter Quantity","readOnly":True}),
		"category":forms.TextInput(attrs={"class":"form-control","placeholder":"Enter category","readOnly":True}),
		"production_date":forms.TextInput(attrs={"class":"form-control","placeholder":"Enter Production date","readOnly":True}),
		"expiry_date":forms.TextInput(attrs={"class":"form-control","placeholder":"Enter expiry date","readOnly":True}),
		"org_name":forms.TextInput(attrs={"class":"form-control","placeholder":"Enter Organization name"}),
		"tablets_required":forms.TextInput(attrs={"class":"form-control","placeholder":"Tablets required"}),
		}